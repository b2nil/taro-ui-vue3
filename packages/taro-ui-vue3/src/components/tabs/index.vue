...
<script lang="ts">
import { defineComponent, reactive, ref, watch, onMounted, onUnmounted, CSSProperties, computed, toRefs } from 'vue'
...
export default defineComponent({
  ...
  setup(props: AtTabsProps, { slots }) {
    ...
    const rootStyle = computed(() => mergeStyle(props.customStyle, heightStyle.value))
    ...
    const bodyStyle = computed(() => {
      ...
      return mergeStyle(bodyStyle, heightStyle.value)
    })
