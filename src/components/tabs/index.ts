...
const AtTabs = defineComponent({
  ...
  setup(props: AtTabsProps, { slots }) {
    ...
    return () => {
      const { _scrollLeft, _scrollTop, _scrollIntoView } = state
      ...
      const tabItemClass = computed(() => (idx: number) => classNames({
        'at-tabs__item': true,
      ...
      return (
        h(View, {
          ...
          style: mergeStyle(heightStyle.value, props.customStyle!)
        }, {
          default: () => [
            // scroll view ?
            props.scroll
            ...
            h(View, {
              class: 'at-tabs__body',
              style: mergeStyle(bodyStyle.value, heightStyle.value),
              onTouchStart: handleTouchStart,
              onTouchEnd: handleTouchEnd,
              onTouchMove: handleTouchMove,
            }, {
              default: () => [
                h(View, { class: 'at-tabs__underline', style: underlineStyle.value }),
